-- Fix topic_completions: columns must be CHAR(36) to match parent tables
-- users.id and course_curriculum_topics.id are both CHAR(36)
-- but topic_completions used VARCHAR(36), causing FK constraint failures
...
ALTER TABLE topic_completions MODIFY COLUMN student_user_id CHAR(36) NOT NULL;
ALTER TABLE topic_completions MODIFY COLUMN topic_id CHAR(36) NOT NULL;
...
-- Also fix course_certificates for the same issue
...
ALTER TABLE course_certificates MODIFY COLUMN student_user_id CHAR(36) NOT NULL;
ALTER TABLE course_certificates MODIFY COLUMN course_id CHAR(36) NOT NULL;
